...
export const AboutPage: React.FC<AboutPageProps> = ({location}) => {
    ...
    return (
        <div className="about">
            ...
            <p>Необходимо разработать React-приложение для отображения таблицы с данными.</p>
            <h2>Функционал</h2>
            <ul>
                <li>
                    Сортировка по столбцам: при нажатии на название столбца строки
                ...
                <li>
                    ...
                    пользователь может ввести текст и строки таблицы, данные которых
                    не содержат подстроку, введённую пользователем, скрываются.
                ...
                <li>
                    ...
                    <b> Добавить в таблицу</b> которая вставляет заполненный ряд в начало таблицы
                </li>
            </ul>
            <p>
            ...
            <p>
                ...
                <a
                    ...
                    &description={lorem|32">Маленький
                </a>
            </p>
            <p>
            ...
            <ul>
                <li>
                    ...
                    Зависание интерфейса при выполнении операций загрузки данных,
                    фильтрации, сортировки недопустимо.
                </li>
                <li>Во время загрузки данных стоит показать какой-то индикатор</li>
                <li>
                    Использование сторонних библиотек будет плюсом только в случае
                    если это оправданно и вы сможете объяснить причину выбора.
                ...
                <li>
                    Пишите код так, как бы вы его писали в работе — внутренности задания будут
                    оцениваться даже тщательней, чем внешнее соответствие заданию. Код должен
                    быть организован так, чтобы его можно было заново использовать.
                </li>
                <li>Помните про обработку ошибок!</li>
                <li>
                    Верстка может быть самая простая. Визуализацию и украшение делайте на ваш вкус.
                    Мы не против использования Bootstrap или похожего UI фреймворк, но только для UI
                    представления (нельзя использовать JS код для решения задачи, но можно использовать
            ...
            <p>Если выделен пользователем с id = 101, то под таблицей выводим следующую информацию:</p>
            <div className="json-block">
                <pre>Выбран пользователь {'<b>'}Sue Corson{'</b>'}</pre>
                <pre>Описание:</pre>
                <pre>{'<textarea>'}</pre>
                <pre>et lacus magna dolor...</pre>
                <pre>{'</textarea>'}</pre>
                <pre>Адрес проживания: {'<b>'}9792 Mattis Ct{'</b>'}</pre>
                <pre>Город: {'<b>'}Waukesha{'</b>'}</pre>
                <pre>Провинция/штат: {'<b>'}WI{'</b>'}</pre>
                <pre>Индекс: {'<b>'}22178{'</b>'}</pre>
            </div>
            <p>
